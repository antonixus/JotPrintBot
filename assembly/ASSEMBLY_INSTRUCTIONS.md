...
1. **CSN-A2 Micro panel printer** (ESC/POS, 9 V / 12 V)
   ![CSN-A2](assets/CSN-A2_micro_panel_printer.png)
   - **Spec:** [CSN-A2 User Manual](https://cdn-shop.adafruit.com/datasheets/CSN-A2+User+Manual.pdf)
   - **Shop:** https://ali.click/gpp8018

2. **Raspberry Pi Zero W**
   ![RPi Zero W](assets/rpi_zero_w.png)
   - **Spec:** [Pi Zero PDF](https://cdn.sparkfun.com/assets/learn_tutorials/6/7/6/PiZero_1.pdf)
   - **Shop:** https://ali.click/dmq801y

3. **KIS-3R33S DC-DC step-down module**
   ![KIS-3R33S](assets/kis-3r33s_DC-DC_step-down.png)
   - **Spec:** [KIS-3R33S datasheet](https://www.datasheetcafe.com/wp-content/uploads/2016/05/KIS-3R33S.pdf)
   - **Shop:** https://ali.click/ker801a

4. **USB Type-C QC/PD/AFC Trigger-Decoy board** (5 V, 9 V, 12 V, 15 V, 20 V)
   ![Type-C PD trigger](assets/type-c_PD_trigger.png)
   - **Spec:** [Trigger module manual](https://manuals.plus/asin/B0CDWXN1WR)
   - **Shop:** https://ali.click/p1t8018

5. **2.4 GHz Wi‑Fi antenna, 2 dBi, RP-SMA**
   ![RP-SMA antenna](assets/RP-SMA_wifi_antenna.png)
...
2. **Printer power**  
   Connect the PD trigger outputs to the printer power connector:
   - PD **VCC out** → printer **VH** (or +12 V)
   - PD **GND out** → printer **GND**

3. **Step-down input**  
   Using a second pair of wires from the same PD trigger outputs, feed the KIS-3R33S step-down module:
   - PD **GND out** → step-down **IN-**
   - PD **VCC out** → step-down **IN+**

4. **Raspberry Pi power**  
   Connect the step-down outputs to the Raspberry Pi Zero W GPIO power pins:
...
5. **Printer serial (UART)**  
   Connect the CSN-A2 TTL connector to the Raspberry Pi UART (cross TX/RX):
